...
class AdminUsersNotifier extends AsyncNotifier<List<AdminUserModel>> {
  ...
  Future<bool> createUser(String name, String email, String password, String phone, String role) async {
    // Note: Creating auth user from client side without logging in requires Admin API / Edge function.
    // For now we just insert into profiles if allowed.
    return false;
  }
  ...
  Future<bool> deleteUser(String userId) async {
    // Same as createUser, deleting auth user requires Admin API.
    return false;
  }
}
